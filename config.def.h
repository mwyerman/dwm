...
static const char *fonts[]          = { "FiraCode Nerd Font" };
static const char dmenufont[]       = "FiraCode Nerd Font";
...
static const char *fexplorercmd[]  = { "thunar", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_e,      spawn,          {.v = fexplorercmd } },
